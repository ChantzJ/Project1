...
std::shared_ptr<CActor> CSpartyFactory::Create()
{
	...
	auto chain = make_shared<CImageDrawable>(L"Chain", L"images/bloody-chainsaw.png");
	chain->SetCenter(Point(10, 133));
	chain->SetPosition(Point(120 - 55 , 130));
	larm->AddChild(chain);
